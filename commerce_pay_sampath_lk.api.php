...
/**
 * @file
 * Hook documentation for the Commerce (Sampath LK) module.
 */


/**
 * Allows modules to alter the data array used to create a Commerce (Sampath LK) redirect
 ...
 *
 * @see commerce_pay_sampath_lk_order_form()
 */
function hook_commerce_pay_sampath_lk_order_form_data_alter(&$data, $order) {
  // No example.
}
 ...
 *
 * @see commerce_pay_sampath_lk_ipn_process()
 */
function hook_commerce_pay_sampath_lk_ipn_process($order, $payment_method, $ipn) {
  // No example.
}
 ...
 */
function hook_commerce_pay_sampath_lk_api_request_alter(&$nvp, $order, $payment_method) {
  // No example.
}